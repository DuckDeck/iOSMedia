...
struct ImageRecognitionDemo:UIViewControllerRepresentable {
    func makeUIViewController(context: Context) -> OpenCVImageRecognitionViewController {
        return OpenCVImageRecognitionViewController()
    }
    
    func updateUIViewController(_ uiViewController: OpenCVImageRecognitionViewController, context: Context) {
        
    }
    
    
    typealias UIViewControllerType = OpenCVImageRecognitionViewController
