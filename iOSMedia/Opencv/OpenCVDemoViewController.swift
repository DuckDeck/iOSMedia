//
//  OpenCVDemoViewController.swift
//  iOSDemo
//
...
import AVFoundation
import SwiftUI
class OpenCVDemoViewController: UIViewController {
...
extension OpenCVDemoViewController:AVCaptureVideoDataOutputSampleBufferDelegate{
...
struct OpcnCVDemo:UIViewControllerRepresentable {
    func makeUIViewController(context: Context) -> OpenCVDemoViewController {
        return OpenCVDemoViewController()
    }
    
    func updateUIViewController(_ uiViewController: OpenCVDemoViewController, context: Context) {
        
    }
    
    typealias UIViewControllerType = OpenCVDemoViewController
