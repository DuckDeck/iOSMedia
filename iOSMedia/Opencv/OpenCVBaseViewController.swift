...
import UIKit
import AVFoundation
class OpenCVBaseViewController: UIViewController {
    ...
    func initVideo() {
        ...
        _previewLayer.frame = CGRect(x: 20, y: 70, width: layerWidth, height: layerWidth)
        ...
        targetLayer.frame = CGRect(x: 20, y: 70 , width: layerWidth, height: layerWidth)
