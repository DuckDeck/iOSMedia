...
struct VideoBoxDecodeDemo:UIViewControllerRepresentable {
    func makeUIViewController(context: Context) -> VideoBoxDecodeVideoViewController {
        return VideoBoxDecodeVideoViewController()
    }
    
    func updateUIViewController(_ uiViewController: VideoBoxDecodeVideoViewController, context: Context) {
        
    }
    
    typealias UIViewControllerType = VideoBoxDecodeVideoViewController
